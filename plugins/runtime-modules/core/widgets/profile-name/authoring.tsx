...
export const PHI_PROFILE_NAME_WIDGET_BUILDER_PLUGIN: PhiCmsBuilderWidgetPlugin<PhiCmsPaddingOnlyWidgetConfig> = {
  ...PHI_PROFILE_NAME_WIDGET_DEFINITION,
  renderEditor: ({ widget }) => (
    <PhiWidgetEditorPlaceholder
      widget={widget}
      pluginTitle={PHI_PROFILE_NAME_WIDGET_DEFINITION.title}
      summary="Authenticated profile name editor."
    />
  ),
};
