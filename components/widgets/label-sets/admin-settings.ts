...
const PHI_ADMIN_SETTINGS_WIDGET_LABEL_SET = definePhiLabelSet({
  ...
  labels: {
    title: "Site settings",
    description: definePhiMessageLabel("Update the core site identity and contact details."),
    identity_title: "Identity",
    identity_description: definePhiMessageLabel("Site name and technical hostname."),
    urls_title: "URLs",
    urls_description: definePhiMessageLabel("Public base URL for this site."),
    contact_title: "Contact",
    contact_description: definePhiMessageLabel("Support and public contact addresses."),
    technical_title: "Technical",
    technical_description: definePhiMessageLabel("Read-only runtime values derived from the current site configuration."),
    ...
    error_load: definePhiMessageLabel("Failed to load site settings."),
    error_network: definePhiMessageLabel("Network error while updating the site settings."),
    error_invalid_public_base_url: definePhiMessageLabel("Please provide a valid public base URL."),
    error_invalid_support_email: definePhiMessageLabel("Please provide a valid support email address."),
    error_generic: definePhiMessageLabel("The site settings could not be updated."),
    success_title: "Settings updated",
    success_text: definePhiMessageLabel("The site settings have been saved."),
  },
});
