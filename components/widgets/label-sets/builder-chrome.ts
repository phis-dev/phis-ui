...
const PHI_BUILDER_CHROME_WIDGET_LABEL_SET = definePhiLabelSet({
  ...
  labels: {
    ...
    root_route_landing_page: PHI_BUILDER_CHROME_WIDGET_DEFAULT_LABELS.rootRoute.landingPage,
    root_route_landing_page_empty: PHI_BUILDER_CHROME_WIDGET_DEFAULT_LABELS.rootRoute.landingPageEmpty,
    root_route_landing_page_adopted: PHI_BUILDER_CHROME_WIDGET_DEFAULT_LABELS.rootRoute.landingPageAdopted,
    area_settings_action: PHI_BUILDER_CHROME_WIDGET_DEFAULT_LABELS.areaSettings.action,
    area_settings_title: PHI_BUILDER_CHROME_WIDGET_DEFAULT_LABELS.areaSettings.title,
    area_settings_close: PHI_BUILDER_CHROME_WIDGET_DEFAULT_LABELS.areaSettings.close,
...
export async function getPhiBuilderChromeWidgetLabels(
  ...
  return {
    ...
    rootRoute: {
      ...
      landingPage: labels.root_route_landing_page,
      landingPageEmpty: labels.root_route_landing_page_empty,
      landingPageAdopted: labels.root_route_landing_page_adopted,
    },
    areaSettings: {
      action: labels.area_settings_action,
      title: labels.area_settings_title,
      close: labels.area_settings_close,
