...
const PHI_BUILDER_MODULES_PAGE_LABEL_SET = definePhiLabelSet({
  ...
  labels: {
    ...
    usage_where: PHI_BUILDER_MODULES_PAGE_DEFAULT_LABELS.usage.where,
    usage_blocks: PHI_BUILDER_MODULES_PAGE_DEFAULT_LABELS.usage.blocks,
    usage_shell: PHI_BUILDER_MODULES_PAGE_DEFAULT_LABELS.usage.shell,
    usage_confirm: PHI_BUILDER_MODULES_PAGE_DEFAULT_LABELS.usage.confirm,
    usage_cancel: PHI_BUILDER_MODULES_PAGE_DEFAULT_LABELS.usage.cancel,
...
export async function getPhiBuilderModulesPageLabels(
  ...
  return {
    ...
    usage: {
      ...
      intro: labels.usage_intro,
      area: labels.usage_area,
      where: labels.usage_where,
      blocks: labels.usage_blocks,
      shell: labels.usage_shell,
      confirm: labels.usage_confirm,
      cancel: labels.usage_cancel,
    },
    publicRoutes: {
