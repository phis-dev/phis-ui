 ...
 */
export function createPhiPublicRuntimeModuleClientBoundary(
  siteModules: PhiSiteModuleClientContributions = PHI_NO_SITE_MODULE_CLIENT_CONTRIBUTIONS,
) {
  const manifests = extendWithPhiSiteModuleClientManifests(siteModules, "public", {
  ...
  return function PhiPublicRuntimeModuleClientBoundary({
    children,
  }: {
...
export const PhiPublicRuntimeModuleClientBoundary = createPhiPublicRuntimeModuleClientBoundary();
