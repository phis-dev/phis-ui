...
const PHI_CMS_WIDGET_MODULE_BY_TYPE_KEY: Readonly<Record<string, keyof typeof PHI_CMS_WIDGET_PLUGIN_KEYS>> = {
  ...
  "builder-brand-identity-controls": "theme",
  ...
  "builder-layout-padding-inspector": "builder",
...
export const PhiCmsWidgetType = {
  ...
  Otp: defineWidgetType(resolvePhiCmsWidgetPluginKey("otp"), "otp"),
  ...
  FormPreview: defineWidgetType(resolvePhiCmsWidgetPluginKey("form-preview"), "form-preview"),
  Gallery: defineWidgetType(resolvePhiCmsWidgetPluginKey("gallery"), "gallery"),
  ...
  SlotUpload: defineWidgetType(resolvePhiCmsWidgetPluginKey("slot-upload"), "slot-upload"),
