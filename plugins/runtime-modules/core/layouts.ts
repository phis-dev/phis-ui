...
export const PHI_RUNTIME_MODULE_LAYOUTS: readonly PhiRuntimeModuleLayoutDefinition[] = [
  ...
  defineCoreLayout(PHI_CAROUSEL_LAYOUT_DEFINITION, () => import("../../../components/layouts/plugins/carousel-layout-plugin").then((module) => module.PHI_CAROUSEL_LAYOUT_PLUGIN)),
