...
const PHI_BUILDER_CHROME_WIDGET_LABEL_SET = definePhiLabelSet({
  ...
  labels: {
    ...
    root_route_redirect: PHI_BUILDER_CHROME_WIDGET_DEFAULT_LABELS.rootRoute.redirect,
    root_route_select_target: PHI_BUILDER_CHROME_WIDGET_DEFAULT_LABELS.rootRoute.selectTarget,
    root_route_no_target: PHI_BUILDER_CHROME_WIDGET_DEFAULT_LABELS.rootRoute.noTarget,
...
export async function getPhiBuilderChromeWidgetLabels(
  ...
  return {
    ...
    rootRoute: {
      ...
      redirect: labels.root_route_redirect,
      selectTarget: labels.root_route_select_target,
      noTarget: labels.root_route_no_target,
    },
    pageTitles: {
