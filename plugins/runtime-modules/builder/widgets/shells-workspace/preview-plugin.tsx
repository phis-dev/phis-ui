...
export const PHI_BUILDER_SHELLS_WORKSPACE_WIDGET_PREVIEW_PLUGIN: PhiCmsPreviewWidgetPlugin<Record<string, never>> = {
  ...PHI_BUILDER_SHELLS_WORKSPACE_WIDGET_DEFINITION,
  renderPreview: () => <PhiBuilderWorkspacePreviewSkeleton kind="shells" />,
};
