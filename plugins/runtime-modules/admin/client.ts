 ...
 */
export const PhiLazyAdminRuntimeControllerClient = dynamic(() =>
  import("../../../plugins/runtime-modules/admin/controller/client").then((module) => module.PhiAdminRuntimeControllerClient));
