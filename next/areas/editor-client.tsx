 ...
 */
export function createPhiEditorRuntimeModuleClientBoundary(
  siteModules: PhiSiteModuleClientContributions = PHI_NO_SITE_MODULE_CLIENT_CONTRIBUTIONS,
) {
  const manifests = extendWithPhiSiteModuleClientManifests(siteModules, "editor", {
  ...
  return function PhiEditorRuntimeModuleClientBoundary({
    children,
  }: {
...
export const PhiEditorRuntimeModuleClientBoundary = createPhiEditorRuntimeModuleClientBoundary();
