 ...
 */
export const PhiLazyAppRuntimeControllerClient = dynamic(() =>
  import("../../../components/runtime/app-base-controller-plugin").then((module) => module.PhiAppBaseControllerClient));
