...
const PHI_BUILDER_MODULES_PAGE_LABEL_SET = definePhiLabelSet({
  ...
  labels: {
    ...
    category_media: PHI_BUILDER_MODULES_PAGE_DEFAULT_LABELS.categories.media,
    category_commerce: PHI_BUILDER_MODULES_PAGE_DEFAULT_LABELS.categories.commerce,
    category_identity: PHI_BUILDER_MODULES_PAGE_DEFAULT_LABELS.categories.identity,
    category_communication: PHI_BUILDER_MODULES_PAGE_DEFAULT_LABELS.categories.communication,
    category_events: PHI_BUILDER_MODULES_PAGE_DEFAULT_LABELS.categories.events,
    category_analytics: PHI_BUILDER_MODULES_PAGE_DEFAULT_LABELS.categories.analytics,
    category_integration: PHI_BUILDER_MODULES_PAGE_DEFAULT_LABELS.categories.integration,
...
export async function getPhiBuilderModulesPageLabels(
  ...
  return {
    ...
    categories: {
      ...
      media: labels.category_media,
      commerce: labels.category_commerce,
      identity: labels.category_identity,
      communication: labels.category_communication,
      events: labels.category_events,
      analytics: labels.category_analytics,
      integration: labels.category_integration,
